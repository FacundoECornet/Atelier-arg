    ...
    text: (
      <>
        ...
        <p className="text-lg sm:text-xl max-w-2xl mx-auto">
          En Atelier Homes disponemos de una metodología de venta basada en la fusión de
          arquitectura, diseño de interiores y marketing inmobiliario digital, importada de Europa.
        </p>
      </>
    ),
    isIntro: true,
