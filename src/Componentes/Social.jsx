    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a data-social="whatsapp" aria-label="Whatsapp" href="https://wa.me/5493814159547">
        ...
        <li className="icon-content">
          <a data-social="facebook" aria-label="Facebook" href="https://www.facebook.com/atelierinmobiliaria/?locale=es_LA">
            <div className="filled" />
        ...
        <li className="icon-content">
          <a data-social="instagram" aria-label="Instagram" href="https://www.instagram.com/atelierhomes.ar/">
            <div className="filled" />
