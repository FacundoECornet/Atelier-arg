...
const ModalTasacion = ({ showModal, handleCloseModal }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50 p-4">
      <div className="bg-white w-full max-w-5xl max-h-[90vh] overflow-y-auto rounded-lg shadow-lg p-8 relative flex flex-col">
        {/* Botón cerrar */}
        <button
        ...
        {/* Título */}
        <h2 className="text-3xl font-bold text-center mb-6">Tasación de Propiedad</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 flex-grow flex flex-col">
          {step === 1 && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <input
                ...
                placeholder="Nombre *"
                required
                className="p-3 border border-gray-300 rounded shadow-sm focus:outline-none focus:ring-2 focus:ring-black"
              />
              <input
                name="apellido"
              ...
              <textarea
                name="mensajeBreve"
                rows="3"
                value={formData.mensajeBreve}
                onChange={handleChange}
                placeholder="Mensaje breve (opcional)"
                className="p-3 border border-gray-300 rounded shadow-sm focus:outline-none focus:ring-2 focus:ring-black md:col-span-2"
              />
              <button
                type="button"
                onClick={handleNext}
                className="col-span-2 bg-black text-white py-3 rounded-md font-semibold hover:bg-gray-800 transition"
              >
                Siguiente
              </button>
            </div>
          ...
          {step === 3 && (
            <div className="flex flex-col gap-4">
              ...
              <div className="relative w-full h-60 rounded overflow-hidden border border-gray-300 shadow-sm">
                {loadingGeo && (
